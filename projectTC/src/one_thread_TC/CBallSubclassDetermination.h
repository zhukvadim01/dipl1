#ifndef CBALLSUBCLASSDETERMINATION_H
#define CBALLSUBCLASSDETERMINATION_H
...
{
public:
    CBallSubclassDetermination();

    ~CBallSubclassDetermination();

    TrajType_OutputData m_OutTrajType;  //output data for trajectory type
    BTMark_OutputData   m_OutMark;      //output data for mark
    ...
    // PACKAGE		:   AirBallist
    // FUNCTION 	:   CBallSubclassDetermination::FillInputData_TType
    // DESCRIPTION	:   Filling of input data for trajectory type determination
    // INPUTS		:	Structure containing the input data
    // RETURNS		:	None
    void FillInputData_TType(TrajType_InputData &InData);

    // PACKAGE		:   AirBallist
    // FUNCTION 	:   CBallSubclassDetermination::FillInputData_BTMark
    // DESCRIPTION	:   Filling of input data for BT mark determination
    // INPUTS		:	Structure containing the input data
    // RETURNS		:	None
    void FillInputData_BTMark(BTMark_InputData &InData);
    ...
    // RETURNS		:	None
    void CalculateAndCheckMark(const bool p_calc_mark);
...
//    // PACKAGE		:   AirBallist
//    // FUNCTION 	:   CBallSubclassDetermination::Drop_GT
//    // DESCRIPTION	:   Drop single track
//    // INPUTS		:	Index of generalized track
//    // RETURNS		:	None
//    void Drop_ST(qint32 ind_ST);
...
private:
    TrajType_InputData* m_pTTypeInpData{nullptr};  //pointer to structure containing input data for trajectory type determination

    BTMark_InputData*   m_pMarkInpData{nullptr};   //pointer to structure containing input data for BT mark determination
    ...
    void OnceMarkDet(BMMark_AndDiapason &BMMark);
    ...
    // INPUTS		:	None
    // RETURNS		:	Resulting value of BT mark and BT mark diapason
    void MarkDet_H_He(BMMark_AndDiapason &BMMark);
    ...
    // INPUTS		:	None
    // RETURNS		:	Resulting value of BT mark and BT mark diapason
    void MarkDet_He(BMMark_AndDiapason &BMMark);
    ...
    // INPUTS		:	None
    // RETURNS		:	Current value of BT mark and BT mark diapason
    void MarkCorr_Distance(BMMark_AndDiapason &BMMark);
...
#endif // CBALLSUBCLASSDETERMINATION_H
