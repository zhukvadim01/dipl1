...
#ifndef CTRLAIR_BALLIST_H
#define CTRLAIR_BALLIST_H
...
class CtrlAIR_BALLIST : public QObject
{
public:
    CtrlAIR_BALLIST();
    ~CtrlAIR_BALLIST();
    ...
    QRecursiveMutex                 m_CritSect;     //critical section
...
private:
    ...
    CAirBallist_Processing      m_CAirBallProc;         //Instance of the class CAirBallist_Processing
