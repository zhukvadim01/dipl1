...
//
#ifndef _rip_tc_prognoz_h
#define _rip_tc_prognoz_h
...
{
protected:
//	Pr_Input	*m_PrInput;	//Input data
	
//	qint32		IF;			//index in array
...
//    qreal convertGSCtoGeODeZ_hight(const qreal X, const qreal Y, const qreal Z);
...
public:
    ...
    //PACKAGE		:   AirBallist
    //FUNCTION		:   COnePrognosis::InitInput
    //DESCRIPTION	:   initialization of input data
    //INPUTS		:   Reference to structure for input data
    //RETURNS		:   void
//	void InitInput(Pr_Input &inp);

    //PACKAGE		:   AirBallist
    //FUNCTION		:   COnePrognosis::GetPrognosis
    //DESCRIPTION	:   Prognostication function
    //INPUTS		:   boolean sign of first call, boolean sign of forced prognosis, reference to output structure
    //RETURNS		:   void
//	void GetPrognosis(bool IsFirst, bool ForcedProgn, Pr_Output &Out);
    ...
    void CalcEllipse (const TMatrix<DIM_CV> &K, const qreal t, const qreal tp, const GLPointDouble3D &SP, const GLPointDouble3D &SV,
        qreal &aI, qreal &bI, qreal &betaI);

    void CalcEllipse (TMatrix<SIZE_M> &K, const qreal t, const qreal tp, const GLPointDouble3D &SP, const GLPointDouble3D &SV,
        qreal &aI, qreal &bI, qreal &betaI);
    ...
    //PACKAGE		:   AirBallist
    //FUNCTION		:   COnePrognosis::SetHmax
    //DESCRIPTION	:   Sets given value of maximum height
    //INPUTS		:   Given value of maximum height (m)
    //RETURNS		:   None
//    void SetHmax(qreal NewHmax);
    ...
    //PACKAGE		:   AirBallist
    //FUNCTION		:   COnePrognosis::SetTApogee
    //DESCRIPTION	:   Sets given value of time of the apogee
    //INPUTS		:   Given value of time of the apogee (s)
    //RETURNS		:   None
//    void SetTApogee(qreal NewTApogee);
