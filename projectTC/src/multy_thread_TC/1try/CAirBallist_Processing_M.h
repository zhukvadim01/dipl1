...
class CAirBallist_Processing_GD
{
    friend class CAirBallist_Processing_M;

public:
    CAirBallist_Processing_GD();
    ~CAirBallist_Processing_GD();
...
public:
    CAirBallist_Processing_M()  = delete;
    explicit CAirBallist_Processing_M(std::shared_ptr<CAirBallist_Processing_GD> pGD);
    ~CAirBallist_Processing_M();


    std::shared_ptr<CAirBallist_Processing_GD> m_pGlobalData;
...
public:
    ...
    CAirBall_Proc_InnerData_GT get_Proc_InnerData_GT(const qint32 ind_GT);
    void set_Proc_InnerData_GT(const qint32 ind_GT, const CAirBall_Proc_InnerData_GT& data);
...
#endif // CAIRBALLIST_PROCESSINGM_H
