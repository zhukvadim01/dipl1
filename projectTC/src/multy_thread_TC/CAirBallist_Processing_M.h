#ifndef CAIRBALLIST_PROCESSINGM_H
#define CAIRBALLIST_PROCESSINGM_H
...
class CAirBallist_Processing_M
{
    friend class CtrlAIR_BALLIST_M;

public:
    CAirBallist_Processing_M();
    ~CAirBallist_Processing_M();
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void AirBallist_Realization(const CAirBall_Proc_InputData_GT* a_pInData,
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void AirBallist_Realization_ST(const CAirBall_Proc_InputData_ST *a_pInData);
    ...
    // RETURNS		:	None
    void AirBallist_Realization_Satellite(const CAirBall_Proc_InputData_GT *a_pInData,
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void NewTrackProcessing_GT(const CAirBall_Proc_InputData_GT* a_pInData);
...
private:
    ...
    CPathBranchDetermination_M    m_PathBranchDet;     //instance of class that implements the path and branch determination
    CBallSubclassDetermination_M  m_BallSubclDet;      //instance of class that implements the ballistic subclass and trajectory type determination
    CBallisticProlongation_M      m_BallProlong;       //instance of class that implements prolongation tasks
    CBallist_ActiveProgn_M        m_BallActPred;       //instance of class that implements prediction on active path
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void NewTrackProcessing_ST(const CAirBall_Proc_InputData_ST *a_pInData);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void UpdateCluster(const CAirBall_Proc_InputData_GT *a_pInData);
    ...
    // RETURNS		:	None
    void CalcTrajParam(void *a_pInData, const bool IsGT, TrajParamBall &trajPar);
    ...
    bool CurrSTIsWellSmoothed(const CAirBall_Proc_InputData_ST *a_pInData);
    ...
    bool CurrGTIsWellSmoothed(const CAirBall_Proc_InputData_GT *a_pInData);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void Path_Branch_Processing_GT(const CAirBall_Proc_InputData_GT *a_pInData,
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void Path_Branch_Processing_ST(const CAirBall_Proc_InputData_ST *a_pInData,
                                   const TrajParamBall &trajPar);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void Active_Prediction_Processing(const CAirBall_Proc_InputData_GT *a_pInData,
                                      const TrajParamBall &trajPar,
                                      CAirBall_Proc_OutData &a_OutData_Ballist);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void DeterminationBallCoeff(const CAirBall_Proc_InputData_GT *a_pInData);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void Prediction_Processing(const CAirBall_Proc_InputData_GT *a_pInData,
                               const TrajParamBall &trajPar,
                               CAirBall_Proc_OutData &a_OutData_Ballist);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void TrajType_Processing(const CAirBall_Proc_InputData_GT *a_pInData,
                             const TrajParamBall &trajPar,
                             CAirBall_Proc_OutData &a_OutData_Ballist);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void BT_Mark_Processing(const CAirBall_Proc_InputData_GT *a_pInData,
                            const TrajParamBall &trajPar,
                            CAirBall_Proc_OutData &a_OutData_Ballist);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void HorizontalManeuverDetection(const CAirBall_Proc_InputData_GT *a_pInData);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void TimeEAP_Updating(const CAirBall_Proc_InputData_GT *a_pInData,
                          CAirBall_Proc_OutData &a_OutData_Ballist);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void ParametersEAP_Updating(const CAirBall_Proc_InputData_GT *a_pInData);
    ...
    bool CheckConditionsForPredict(const CAirBall_Proc_InputData_GT *a_pInData,
                                   const TrajParamBall &trajPar);
    ...
    bool CheckPredictionDeviation(const CAirBall_Proc_InputData_GT* a_pInData);
    ...
    bool Estimate_Threat(const CAirBall_Proc_InputData_GT *a_pInData);
    ...
    // INPUTS		:	None
    // RETURNS		:	None
    void ReturnFromPassToAct_Processing(const CAirBall_Proc_InputData_GT *a_pInData,
                                        CAirBall_Proc_OutData &a_OutData_Ballist);
};
