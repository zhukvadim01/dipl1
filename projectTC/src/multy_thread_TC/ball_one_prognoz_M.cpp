...
namespace AIR_BALL{
//    static std::ofstream out_param(qPrintable(QString("%1/progn_traj_M.txt").arg(log_path)));
    static FILE* out_param = nullptr;
}


COnePrognosis_M::COnePrognosis_M(FILE* &out_param )
{
//    Reset();
    ...
    AIR_BALL::out_param = out_param;
}


COnePrognosis_M::~COnePrognosis_M() {
}


void COnePrognosis_M::Reset()
{   
    std::vector<M10>().swap(Param);
    Param.reserve(1);
    std::vector<qreal>().swap(VectH);
...
//FUNCTION		:COnePrognosis_M::InitConst
//
...
//RETURNS		:void
//
void COnePrognosis_M::InitConst(const One_Pr_Const &cnst)
{
	m_PrConst = cnst;
}
...
void COnePrognosis_M::CalcTrack(const qreal t0,const qreal x0,const qreal y0,const qreal z0,const qreal v0x,const qreal v0y,const qreal v0z,const qreal gamma,const bool P_Inverse)
{
	this->UK[0] = v0x;
	this->UK[1] = v0y;
	this->UK[2] = v0z;
...
bool COnePrognosis_M::CalcTrack_OnTime(const qreal t0,const qreal t_end,const qreal x0,const qreal y0,const qreal z0,const qreal v0x,const qreal v0y,const qreal v0z,const qreal gamma,const bool P_Inverse)
{
...
bool COnePrognosis_M::CalcTrack_Aeroball(const qreal t0, const qreal t0_aeroball, const qreal x0, const qreal y0, const qreal z0, const qreal v0x, const qreal v0y, const qreal v0z, const qreal gamma, const qreal delta)
{
    this->UK[0] = v0x;
    this->UK[1] = v0y;
    this->UK[2] = v0z;
...
void COnePrognosis_M::OutputTrack()
{
    QString l_log;
    for (qint32 i = 0; i < static_cast<qint32> (Param.size()); i++)
    {
        ...
        {
            l_log += QString("%1\t").arg(Param[i].M_info[j], 0, 'f', 5);
        }
        l_log += "\n";
    }
    tLog(AIR_BALL::out_param, "%s", qPrintable(l_log));
}


void COnePrognosis_M::ClearTrack()
{
    //Param.clear();
    std::vector<M10>().swap(Param);
    std::vector<qreal>().swap(VectH);
...
bool COnePrognosis_M::OutputLastPoint(qreal &Time, qint32 &Size, GLPointDouble3D &Coord, GLPointDouble3D &Vel, GLPointDouble3D &Acc)
{
...
bool COnePrognosis_M::OutputLastPoint(qreal &Time, qint32 &Size, GLPointDouble3D &Coord, GLPointDouble3D &Vel)
{
    if (Param.size() < 1 || dim < 1)
    {
        return false;
...
void COnePrognosis_M::GetProlongedTrack(std::vector<M10> &ProlongedTrack, qint32 &dimension)
{
...
bool COnePrognosis_M::OutputStartPointByTables(const qreal &CurrTime,const Str_Ar_EAP_Param_1Table *pEAP_table, qreal &StartTime, GLPointDouble3D &Coord)
{
...
bool COnePrognosis_M::OutputStartPointByTables(const qreal &CurrTime,const Str_Ar_EAP_Param_1Table *pEAP_table, qreal &StartTime, GLPointDouble3D &CoordSP, qreal &T_passive, GLPointDouble3D &CoordEAP, GLPointDouble3D &VelEAP)
{
    T_passive = 0.;
...
bool COnePrognosis_M::OutputLastPoint(qreal &Time, qint32 &Size, TMatrix<6> &ColumnCV)
{
    if (Param.size() < 1 || dim < 1)
    {
        return false;
...
qint16 COnePrognosis_M::Solution(const bool P_Inverse, const qreal gamma)
{
...
qint16 COnePrognosis_M::SolutionAeroball(const qreal gamma, const qreal delta, M10 &M)
{
...
bool COnePrognosis_M::FindStartByEAP(Str_Ar_EAP_Param_1Table* pEAP_table, const qreal t0, const qreal x0, const qreal y0, const qreal z0,
...
qreal COnePrognosis_M::Check_EAP(const Str_Ar_EAP_Param_1Table *pEAP_table, const qreal currH, const qreal currTheta,
...
void COnePrognosis_M::CalculateSepBoostParam(const Str_Ar_EAP_Param_1Table *pEAP_table, const qint16 i_row, const qreal CurrTheta,
                                           qreal &ResHBoost1, qreal &ResLBoost1, qreal &ResVBoost1,
                                           qreal &ResHBoost2, qreal &ResLBoost2, qreal &ResVBoost2)
{
    ResHBoost1 = 0;
...
qreal COnePrognosis_M::GetDensity(const qreal x, const qreal y, const qreal z)
{
	qint16 i = 0;
...
qreal COnePrognosis_M::GetAbsVector(const qreal x, const qreal y, const qreal z)
{
    return(sqrt(x*x + y*y + z*z));
}

//Function for calculation of the height above ellipsoid surface
qreal COnePrognosis_M::GetHeight(const qreal x, const qreal y, const qreal z)
{
...
void COnePrognosis_M::RecalcSystemCoefs(const qreal x, const qreal y, const qreal z,
...
void COnePrognosis_M::RungeKutta(const qreal uk[6], const qreal Ak, const qreal Bk, const qreal Ck,
...
void COnePrognosis_M::RungeKutta_Aeroball(const qreal uk[], const qreal Ak, const qreal Bk, const qreal Ck, const qreal Rok, const qreal Vk, const qreal gam, const qreal delta, const qreal h)
{
    qint16 j;
    qreal uk1[6];
...
void COnePrognosis_M::F_Diff_Eq(const qreal U1[6], const qreal A1, const qreal B1, const qreal C1,
...
void COnePrognosis_M::F_Diff_Eq_Inverse(const qreal U1[6],const qreal A1,const qreal B1,const qreal C1,
                                      const qreal Ro1,const qreal V1,const qreal Gam1)
{
    const qreal x = U1[3];
    const qreal y = U1[4];
...
void COnePrognosis_M::F_Diff_Eq_Aeroball(const qreal U1[6], const qreal A1, const qreal B1, const qreal C1,
...
//qreal COnePrognosis_M::convertGSCtoGeODeZ_hight(const qreal X, const qreal Y, const qreal Z)
//{
...
//FUNCTION		:COnePrognosis_M::CalcEllipse
//
...
//RETURNS		:void
//
void COnePrognosis_M::CalcEllipse(const TMatrix<DIM_CV> &K, const qreal t,
...
void COnePrognosis_M::CalcEllipse(const TMatrix<DIM_CV> &K, const GLPointDouble3D &SP, const GLPointDouble3D &SV, qreal &aI, qreal &bI, qreal &betaI)
{
    CalcEllipse(K, 0, 0, SP, SV, aI, bI, betaI);
}


void COnePrognosis_M::CalcEllipse(GLMatrix &K, const qreal t, const qreal tp, const GLPointDouble3D &SP, const GLPointDouble3D &SV, qreal &aI, qreal &bI, qreal &betaI)
{
    CMatrix fMatr;
    TMatrix<DIM_CV> K1;
...
void COnePrognosis_M::CalcBetaEpsilon(const CTopocentric &CTC_V, qreal &beta2, qreal &eps2)
{
    beta2 = 0.;
    eps2 = 0.;
...
//void COnePrognosis_M::CalcEllipse(GLMatrix &K, qreal t, qreal tp, GLPointDouble3D &SP, GLPointDouble3D &SV, qreal &aI, qreal &bI, qreal &betaI)
//{
//    SPoint SP_curr;
//    SVel   SV_curr;
...
void COnePrognosis_M::GetPolinom_4deg(Pred_Polinom &Pol)
{
    qreal arrT[5];
	qreal A[5][3];
	qreal a0[3];
...
bool COnePrognosis_M::GetSignCorrectProgn()
{
    return SignCorrectProl;
}


bool COnePrognosis_M::GetPolinom_Ndeg(const qint16 N, std::vector<M10> &ProlTrack, const qint32 ind_begin, const qint32 ind_end,
...
void COnePrognosis_M::GetM10_ForPoint(const qreal T, const GLPointDouble3D &Coord, const GLPointDouble3D &Vel, const qreal Gamma, M10 &Result)
{
    Result.Reset();
    Result.M_info[0] = T;
...
bool COnePrognosis_M::GetPolinom(std::vector<M10> &ProlTrack, Polynoms_data &Pol)
{
    Pol.Reset();
...
bool COnePrognosis_M::GetPolinom(Polynoms_data &Pol)
{
    bool bRes = true;
...
Polynoms_data COnePrognosis_M::GetPolynomECEF()
{
    return PolynomComb;
}


Polynoms_data COnePrognosis_M::GetPolynomNUE()
{
    return PolynomCombNUE;
}


bool COnePrognosis_M::CalcPolynom()
{
...
bool COnePrognosis_M::RecalcPolynomToNUE(CGeodesic &Center, const Polynoms_data &PolECEF, Polynoms_data &PolNUE)
{
    bool bRes = true;
...
bool COnePrognosis_M::RecalcPolynomToNUE(CGeodesic &Center)
{
    return RecalcPolynomToNUE(Center, PolynomComb, PolynomCombNUE);
}


//void COnePrognosis_M::SetHmax(qreal NewHmax)
//{
//    Hmax = NewHmax;
//}


qreal COnePrognosis_M::GetHmax()
{
    return Hmax;
}


//void COnePrognosis_M::SetTApogee(qreal NewTApogee)
//{
//    tApogee = NewTApogee;
//}


qreal COnePrognosis_M::GetTApogee()
{
    return tApogee;
}


bool COnePrognosis_M::extrCoordByCombPolynom(const qreal _time, const Polynoms_data &Pol, GLPointDouble3D &ResPoint)
{
    bool bRes = true;
    try
    {        
...
bool COnePrognosis_M::extrCoordByCombPolynom(const qreal _time, GLPointDouble3D &ResPoint)
{
    return extrCoordByCombPolynom(_time, PolynomComb, ResPoint);
}


bool COnePrognosis_M::extrCoordByCombPolynomNUE(const qreal _time, GLPointDouble3D &ResPoint)
{
    return extrCoordByCombPolynom(_time, PolynomCombNUE, ResPoint);
}


bool COnePrognosis_M::extrCoordVelByCombPolynom(const qreal _time, const Polynoms_data &Pol, GLPointDouble3D &ResPoint, GLPointDouble3D &ResVel)
{
    bool bRes = true;
    try
    {        
...
bool COnePrognosis_M::extrCoordVelByCombPolynom(const qreal _time, GLPointDouble3D &ResPoint, GLPointDouble3D &ResVel)
{
    return extrCoordVelByCombPolynom(_time, PolynomComb, ResPoint, ResVel);
}


bool COnePrognosis_M::extrCoordVelByCombPolynomNUE(const qreal _time, GLPointDouble3D &ResPoint, GLPointDouble3D &ResVel)
{
    return extrCoordVelByCombPolynom(_time, PolynomCombNUE, ResPoint, ResVel);
}


void COnePrognosis_M::GetTPSCPolinom(const std::vector<M10> &P, const CGeodesic &Ctpsc, Pred_Polinom &TPol)
{
    qreal arrT[3];
	qreal A[3][3];
	qreal a0[3];
...
void COnePrognosis_M::TransmitPointerToTheLogFiles(FILE *_pLogEll)
{
    m_pLogEll = _pLogEll;
}
