#ifndef CBALLISTICPROLONGATIONM_H
#define CBALLISTICPROLONGATIONM_H
...
class CBallisticProlongation_M
{
    friend class CAirBallist_Processing_M;

public:
    CBallisticProlongation_M();
    ~CBallisticProlongation_M();
    ...
    //INPUTS		:   None
    //RETURNS		:   None
    void CalcStartPoint(const CBallProl_Input *pInData, CBallProl_Output &rOutData);
    ...
    bool CalcStartPointByInvProl(const CBallProl_Input *pInData,
    ...
    //RETURNS		:   None
    void CalcStartPointByTable(const CBallProl_Input *pInData,
                               COnePrognosis_M &rOneProgn,
                               CBallProl_Output& rOutData,
                               Str_Ar_EAP_Param_1Table* pEAP_table, bool bSingleValued);
    ...
    //INPUTS		:   None
    //RETURNS		:   None
    void EstimationStartPointByReverseExtr(const CBallProl_Input *pInData,
                                           CBallProl_Output &rOutData);
    ...
    //RETURNS		:   None
    void CalcFallPoint(const CBallProl_Input *pInData,
                       CBallProl_Output &rOutData,
                       const bool ForcedProlong=false);
    ...
    //RETURNS		:   None
    void CalcPolynomSatellite(const CBallProl_Input *pInData,
                              CBallProl_Output &rOutData);
    ...
    bool CheckConditionsForStartPointDownPr(const CBallProl_Input *pInData,
    ...
    //INPUTS		:   None
    //RETURNS		:   True if result is OK
    bool CalculateTrapezeAB(const CBallProl_Input *pInData, CBallProl_Output &rOutData);
    ...
    //INPUTS		:   None
    //RETURNS		:   None
    void CorrectionStartPoint(const CBallProl_Input *pInData);
    ...
    bool CheckStartPoint(const CBallProl_Input *pInData, const qreal &tStart,
    ...
    //RETURNS		:   None
    void GetOutPoints(qint32 GTInd, qint32 ind_ball, CBallProl_Output &rOutData);
...
private:    
    ...
    //RETURNS		:   None
    void GlueProlongedTrack(const CBallProl_Input *pInData,
                            CBallProl_Output &rOutData,
    ...
    qreal GetProlPeriod(const CBallProl_Input *pInData);
    ...
    //INPUTS		:   None
    //RETURNS		:   None
    void CorrInverseProlTrack(const CBallProl_Input *pInData,
                              bool bNewEAP=false, qreal tNewEAP=0,
                              GLPointDouble3D PointNewEAP=GLPointDouble3D(0,0,0));
    void CorrInverseProlTrack_old1(const qint32 ind_ball,
                                   const M10 &SP, const std::vector<M10> &TrackFragment);
    void CorrInverseProlTrack_old(const CBallProl_Input *pInData,
                                  const M10 &SP, const std::vector<M10> &TrackFragment);
    ...
    //RETURNS		:   None
    bool CorrInverseProlTrackTStartLessTOld(const qint32 ind_ball,
    ...
    //RETURNS		:   None
    void CorrInverseProlTrack_MoveToPoint(qint32 BallInd,
    ...
    //RETURNS		:   None
    void CalcOutPoints(qint32 GTInd, qint32 ind_ball, CBallProl_Output &rOutData);
    ...
    //RETURNS		:   None
    void SubstituteOutPoint(const qreal &t0, GLPointDouble3D &Point0, CBallProl_Output &rOutData);
    ...
    qreal CalcDistance(const qint32 ind_ball);
